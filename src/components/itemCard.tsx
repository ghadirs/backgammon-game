...
export default function ItemCard({
  ...
  return (
    <div
      className={`group relative flex h-60 w-full max-w-50 flex-col items-center justify-between overflow-hidden rounded-md border border-[#1A3150] bg-[#09152A]/35 backdrop-blur-xs transition-all hover:bg-[#09152A]/50 hover:shadow-lg hover:border-[#2A4A75] cursor-pointer ${className}`}
