    ...
    return (
      <header className="relative w-full h-[60px] flex items-start justify-between px-6 pt-5 z-20">
        <div className="flex items-center gap-4">
          ...
          <div className="bg-[#0b172a]/80 border border-[#1A3150] rounded-lg px-3 py-1 flex items-center justify-center h-[32px] w-[32px] cursor-pointer hover:bg-[#0b172a] transition-colors">
    ...
    <header className="relative w-full h-[60px] flex items-start justify-between px-6 pt-5 z-20">
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2 cursor-pointer group">
          <CrownIcon className="fas fa-crown text-amber-500 text-lg drop-shadow-md group-hover:scale-110 transition-transform"></CrownIcon>
