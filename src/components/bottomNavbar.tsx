...
const BottomNavbar: React.FC<{}> = () => {
  ...
  return (
    ...
    >
      <ul className='mx-auto grid h-[51px] w-[340px] max-w-[95vw] grid-cols-4 overflow-hidden rounded-tl-[25px] rounded-tr-[25px] bg-black shadow-[0px_4px_4px_rgba(0,0,0,0.25)]'>
        {/* Active (Lobby) */}
