...
const BackgammonBoardComponent: React.FC<Props> = ({
  board,
  diceValues,
  isRolling,
  p1Score = 88,
  ...
  const { WIDTH, HEIGHT, SIDEBAR_WIDTH, QUADRANT_WIDTH, POINT_W } = DIMENSIONS;
...
export default BackgammonBoardComponent;
