...
export function GameDialog({ open, onOpenChange }: GameDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        className="max-w-[560px] min-h-[400px] bg-[#09152A]/85 border-[#1A3150] backdrop-blur-xl rounded-2xl p-0"
        showCloseButton={false}
      >
        <DialogHeader className="border-b border-[#1A3150] px-6 py-5 relative">
          <DialogTitle className="text-2xl font-normal uppercase tracking-wide text-white text-center">
            {gameType ? GameTypeEnum[gameType] : ""}
          </DialogTitle>
          <DialogPrimitive.Close
            onClick={() => onOpenChange(false)}
            className="flex h-9 w-9 items-center justify-center absolute right-6 top-5 rounded-lg border border-red-900/50 bg-[#FF2428] text-white shadow-lg transition-transform hover:scale-105 active:scale-95 cursor-pointer"
          >
...
export function ConfirmPurchaseDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        className="max-w-[560px] bg-[#09152A]/85 border-[#1A3150] backdrop-blur-xl rounded-2xl p-0"
        showCloseButton={false}
      >
        <DialogHeader className="border-b border-[#1A3150] px-6 py-5 relative">
          <DialogTitle className="text-2xl font-normal uppercase tracking-wide text-white text-center">
