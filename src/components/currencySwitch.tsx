...
export default function CurrencySwitch({activeTab, setActiveTab}: CurrencySwitchProps) {
    ...
    return (
        ...
        <div
            className="relative flex h-[40px] w-full max-w-[280px] items-center rounded-lg border border-[#1A3150] bg-[#09152A]/50 p-1 backdrop-blur-md">
            ...
            `}
                    >
                        ...
                        {isActive && (
                            <div
                                className="absolute inset-0 -z-10 rounded-md bg-[#248DDC]/35 shadow-[inset_0_0_15px_rgba(0,0,0,0.25)] border border-[#1A3150]"/>
                        )}
