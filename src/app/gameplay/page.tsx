...
export default function GameplayPage() {
  ...
  return (
    <main className="relative h-screen w-screen overflow-hidden flex items-center justify-center bg-[url('/background.png')] bg-cover bg-center text-white">
      ...
      <div className="relative z-10 grid grid-cols-[120px_1fr_120px] gap-5 w-full h-full">
        {/* LEFT SIDEBAR */}
        <aside className="flex flex-col justify-between items-start h-full pt-4 pl-[14px] box-border">
